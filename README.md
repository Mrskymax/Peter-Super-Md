...
✍️.  ***FORK Peter-super REPO***
    <br>
<a href='https://github.com/Mrskymax/Peter-super-md/fork' target="_blank"><img alt='Fork repo' src='https://img.shields.io/badge/Fork Repo-100000?style=for-the-badge&logo=scan&logoColor=blue&labelColor=black&color=black'/></a>
...
```bash
git clone https://github.com/Mrskymax/Peter-super-md.git
cd Peter-super-md
